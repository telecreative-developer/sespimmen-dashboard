                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Edit Personality</li>
                                    </ul>
                                </div>
                            </div>
                            <!-- /.row -->
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                <?php foreach($kepribadian as $result){?>
                                                    <form method="POST" action="<?php echo base_url()?>update_kepribadian/<?php echo $result->personality_id;?>" class="form-horizontal" enctype="multipart/form-data">
