                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="<?php echo base_url();?>scores">Academic</li></a>
                                        <li class="active">Edit Academic</li>
                                    </ul>
                                </div>
                            </div>
                            <!-- /.row -->
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                <?php foreach($academic as $result){?>
                                                    <form method="POST" action="<?php echo base_url()?>update_academic/<?php echo $result->academic_id;?>" class="form-horizontal" enctype="multipart/form-data">
                                                          ...
                                                          <div class="form-group">
                                                              ...
                                                              <div class="col-sm-10">
                                                                <select name="tipe" class="form-control">
                                                                  ...
                                                                  ?>
                                                                    <option value="<?php echo $category->academic_category_id;?>"><?php echo $category->academic_title;?></option>
                                                                  <?php } ?>
                                                                </select>
                                                              </div>
                                                          </div>
