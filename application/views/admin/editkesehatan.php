                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title">Nilai kesehatan</h2>
                                </div>
                                <!-- /.col-md-6 text-right -->
                            </div>
                            <!-- /.row -->
                            <div class="row breadcrumb-div">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="<?php echo base_url();?>kesehatan">Health</li></a>
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                <?php foreach($kesehatan as $result){?>
                                                    <form method="POST" action="<?php echo base_url()?>update_kesehatan/<?php echo $result->health_id;?>" class="form-horizontal" enctype="multipart/form-data">
