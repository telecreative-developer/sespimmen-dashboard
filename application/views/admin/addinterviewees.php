                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Add Interviewees</li>
            						</ul>
                                </div>
                            </div>
                            <!-- /.row -->
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Input Your Interviewees</small></h5>
                                                </div>
                                            </div>
                                            <div class="panel-body">

                                                <form method="POST" action="<?php echo base_url()?>insertInterviewees" class="form-horizontal">
                                                  
                                                    <div class="form-group">
                                                        <label for="text1" class="col-sm-2 control-label">Interviewees</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="full_name" class="form-control" placeholder="Interviewees" required="ON">
                                                        </div>
                                                    </div>
